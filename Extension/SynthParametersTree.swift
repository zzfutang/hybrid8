    ...
    static func buildTree() -> AUParameterTree {
        ...
        let lfo = AUParameterTree.createGroup(
            ...
            param(SynthParamLFOWaveform, "lfoWave", "LFO Waveform",
                  min: 0, max: 4, value: 0, unit: .indexed,
                  strings: ["Sine", "Square", "Saw Up", "Saw Down", "S&H"]),
            ...
            param(SynthParamLFO1Polarity, "lfo1Polarity", "LFO 1 Polarity",
                  min: 0, max: 1, value: 0, unit: .indexed,
                  strings: ["Bipolar", "Unipolar"]),
            param(SynthParamLFO1Phase, "lfo1Phase", "LFO 1 Phase",
                  min: 0, max: 1, value: 0),
            param(SynthParamLFO2Delay, "lfo2Delay", "LFO 2 Delay",
                  min: 0, max: 2, value: 0, unit: .seconds),
            param(SynthParamLFO2Polarity, "lfo2Polarity", "LFO 2 Polarity",
                  min: 0, max: 1, value: 0, unit: .indexed,
                  strings: ["Bipolar", "Unipolar"]),
            param(SynthParamLFO2Phase, "lfo2Phase", "LFO 2 Phase",
                  min: 0, max: 1, value: 0),
            param(SynthParamLFO3Waveform, "lfo3Wave", "LFO 3 Waveform",
                  min: 0, max: 4, value: 0, unit: .indexed,
                  strings: ["Sine", "Square", "Saw Up", "Saw Down", "S&H"]),
            param(SynthParamLFO3Rate, "lfo3Rate", "LFO 3 Rate",
                  min: 0.05, max: 30, value: 1, unit: .hertz, log: true),
            param(SynthParamLFO3Delay, "lfo3Delay", "LFO 3 Delay",
                  min: 0, max: 2, value: 0, unit: .seconds),
            param(SynthParamLFO3Polarity, "lfo3Polarity", "LFO 3 Polarity",
                  min: 0, max: 1, value: 0, unit: .indexed,
                  strings: ["Bipolar", "Unipolar"]),
            param(SynthParamLFO3Phase, "lfo3Phase", "LFO 3 Phase",
                  min: 0, max: 1, value: 0),
            param(SynthParamLFO1Mode, "lfo1Mode", "LFO 1 Mode",
                  min: 0, max: 2, value: 0, unit: .indexed,
                  strings: ["Loop", "Trig", "1-Shot"]),
            param(SynthParamLFO2Mode, "lfo2Mode", "LFO 2 Mode",
                  min: 0, max: 2, value: 0, unit: .indexed,
                  strings: ["Loop", "Trig", "1-Shot"]),
            param(SynthParamLFO3Mode, "lfo3Mode", "LFO 3 Mode",
                  min: 0, max: 2, value: 0, unit: .indexed,
                  strings: ["Loop", "Trig", "1-Shot"]),
        ])
        ...
        let global = AUParameterTree.createGroup(
            ...
            param(SynthParamUnisonDetune, "unisonDetune", "Unison Detune",
                  min: 0, max: 1, value: 0.25),
            param(SynthParamVibratoLFO, "vibratoLFO", "Vibrato LFO",
                  min: 0, max: 2, value: 0, unit: .indexed,
                  strings: ["LFO 1", "LFO 2", "LFO 3"]),
        ])
